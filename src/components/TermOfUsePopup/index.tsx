  ...
  return <div className='tou-modal'>
    ...
    <div className="modal">
      ...
      <div className="content">
        ...
        <p>Thank you for using Derivable Protocol in our earliest days. We would love to hear about your experience with our product. If you enjoy Derivable or encounter any bug along the way, please notify our team at
          <a href="https://discord.gg/r7V97tSK" target='_blank'> https://discord.gg/r7V97tSK</a>.
          The Derivable team greatly values your attention and experience!</p>
      </div>
