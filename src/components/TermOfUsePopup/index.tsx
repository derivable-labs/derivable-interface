...
const TOU = `Derivable.org, referred to as "we," "us," or "our," is an informational resource for Derivable Protocol, as defined below.

Derivable.org provides information and resources about the fundamentals of the decentralized non-custodial protocol called the Derivable Protocol (the "Derivable Protocol," "Protocol," or "Derivable DApp"). Derivable is not an available access point to the Derivable Protocol.

Please do not use the Site or Interface if you disagree with any of these Terms.

I. USAGE OF THE SITE AND INTERFACE

The Derivable.org site serves solely for informational purposes.

Please note that Derivable.org is not involved in any transactions on the blockchain networks that support the Derivable Protocol. We neither possess, have custody of, nor exert control over any cryptocurrency assets displayed on the Interface. Additionally, we do not store, send, or receive any cryptocurrency assets. It is important to understand that when you engage with Derivable Protocol smart contracts, you always maintain control over your cryptocurrency assets. We do not have access to your private keys.

1. In order to access or utilize the Site or Interface, you affirm and guarantee to Derivable.org the following:
...
Your access is not (a) prohibited by, and does not otherwise violate or assist in violating, any domestic or foreign laws, regulations, rules, statutes, orders, protocols, codes, decrees, letters, directives, requirements, guidance, or guidelines, whether currently in effect or published, that pertain to or are intended to govern or regulate any individual, property, transaction, activity, event, or other matter, including any rules, letters, orders, judgments, directives, or other requirements, guidance, or guidelines issued by any domestic or foreign federal, provincial, state, municipal, local, or other governmental, regulatory, judicial, or administrative authority with jurisdiction over Derivable.org or yourself, and duly enacted and enforceable by law, common law, or equity (collectively referred to as "Applicable Laws"); or (b) contribute to or facilitate any illegal activity.

2. In order to access or utilize the Site or Interface, you acknowledge, comprehend, and consent to the following:

Occasionally, the Site or Interface may become inaccessible or inoperative due to various reasons, including but not limited to: (a) equipment malfunctions, (b) periodic maintenance procedures or repairs conducted by Derivable.org, its suppliers, or contractors, (c) causes beyond Derivable.org's control or that were unforeseeable by Derivable.org, (d) disruptions and temporary or permanent unavailability of the underlying blockchain infrastructure, or (e) unavailability of third-party service providers or external partners for any reason.
...
The pricing information provided on the Site or Interface does not constitute an offer, solicitation of an offer, or any advice regarding or recommendation to engage in transactions with Derivable.org.

Derivable.org does not act as a broker or advisor for you.
...
1. Derivable.org owns all rights, names, logos, and other marks used on the site and the interface. This includes copyrights in and to any content, code, data, or other materials that users may access or use on or through the site or the interface. However, the code for the Derivable Protocol and the Interface (app.Derivable.org) deployed on IPFS is open-sourced. It means that the code is publicly available and can be used, copied, modified, and distributed by anyone. Except for the rights explicitly mentioned in the terms and conditions, your use or access to the site or the interface does not grant you any ownership or other rights.

2. Derivable.org has the right to use and share any comments, bug reports, ideas, or other feedback provided by users, including suggestions for improvement. Users agree that Derivable.org is free to use or not use the feedback received as they see fit, including copying and sharing it with third parties. Derivable.org has no obligation to users regarding the feedback provided.

V, MODIFICATION, SUSPENSION, AND TERMINATION

1. Derivable.org reserves the right, at their sole discretion and with or without prior notice, to modify, suspend, or disable the Site or the Interface, either temporarily or permanently, in whole or in part, for any reason. Upon termination of access, your right to use the Site or the Interface will immediately cease. However, it's worth noting that the code of the interface is not hosted or owned by Derivable.org, so it may still be accessible via a third party. Derivable.org will not be held liable for any losses incurred as a result of any modifications, suspensions, or terminations of the Site or the Interface.

2. Derivable.org may make revisions to the Terms from time to time. Users will be notified of these revisions by updating the date at the top of the Terms and ensuring that the most current version is available at the URL: https://Derivable.org/#/terms-and-conditions. ↗ All modifications to the Terms will be effective upon posting. By continuing to access or use the Site or the Interface after the revised Terms become effective, users agree to be bound by the updated Terms.

VI, RISKS

1. The use of technology related to blockchain, smart contracts, and cryptocurrencies carries inherent risks that users assume by accessing transactions. Derivable.org does not own or control the underlying software that forms blockchain networks. The software underlying blockchain networks is open-source, allowing anyone to use, copy, modify, and distribute it. By using the Interface, users acknowledge and agree to the following:

Derivable.org is not responsible for the operation of the open-source software and networks underlying the Interface.
...
Users are responsible for securing their private keys. Derivable.org does not have access to users' private keys. If users lose control of their private keys, they will permanently and irreversibly lose access to any blockchain-based network. Neither Derivable.org nor any other entity can retrieve or protect users' digital assets. If private keys are lost, users will be unable to transfer their digital assets to any blockchain address or wallet, resulting in the inability to realize any value or utility from their held digital assets.

2. Derivable.org is not responsible for the content of any third party, including information, materials, products, or services that Derivable.org does not own or control. Third parties may offer promotions related to users' access and use of the Interface. Derivable.org does not endorse or assume any responsibility for these resources or promotions. If users access such resources or participate in such promotions, they do so at their own risk. These Terms do not apply to users' dealings or relationships with third parties. Users expressly relieve Derivable.org of any liability arising from the use of such resources or participation in such promotions.
...
5. Derivable.org must comply with applicable laws, which may require them to take certain actions or provide information upon request by government agencies. These actions or disclosures may not necessarily be in the best interests of users.

6. Users assume and agree that Derivable.org will not be held responsible or liable for the risks outlined in Section 9 (not mentioned in the provided content). Users irrevocably waive, release, and discharge all claims, known or unknown, against Derivable.org, its affiliates, and their respective shareholders, members, directors, officers, employees, agents, representatives, suppliers, and contractors related to any of the risks described in Section 6.
...
Engage in transactions involving items that infringe or violate any copyright, trademark, right of publicity, privacy, or any other proprietary right of Derivable.org.
...
Harass, abuse, or harm another person or entity, including Derivable.org's collaborators and service providers.
...
Users understand that Derivable.org is not registered or licensed by any regulatory agency or authority. No regulatory agency or authority has reviewed or approved the use of the Site or the Interface.

Users agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. Derivable.org does not provide any guarantees or warranties of any kind in connection with the Site or the Interface.

IX, INDEMNIFICATION

You will defend, indemnify, and hold harmless Derivable.org and its affiliates, members, managers, employees, attorneys, representatives, suppliers, and contractors from any claim, demand, lawsuit, action, proceeding, investigation, liability, damage, loss, cost, or expense arising out of or relating to:
...
Derivable.org reserves the right to assume, at your expense, the exclusive defense and control of any matter subject to indemnification by you. You agree to cooperate with Derivable.org's defense of any claim. Additionally, you will not settle any claim without Derivable.org's consent or involvement.

X, DISPUTE RESOLUTION & ARBITRATION

Derivable.org will make its best efforts to resolve potential disputes through informal, good faith negotiations. If a potential dispute arises, you are required to contact Derivable.org by sending a written notice of your claim ("Notice") through any of their official channels. The Notice should describe the nature and basis of the claim and specify the relief sought. Derivable.org will respond with a similar notice.

If you and Derivable.org cannot reach an agreement to resolve the claim within sixty (60) days of your Notice, both parties agree to resolve the potential dispute according to the process set forth below.

Any claim or controversy arising out of or relating to the Site, the Interface, or these Terms, or any other acts or omissions for which you believe Derivable.org is liable, including but not limited to any claim or controversy as to arbitrability ("Dispute"), shall be finally and exclusively settled by arbitration under the Corte Civil y Mercantil de Arbitraje (CIMA). You understand and agree that you are required to resolve all Disputes by binding arbitration. The arbitration will be confidential and conducted before a single arbitrator, who will be selected in accordance with the CIMA rules. The arbitration will typically take place in Madrid, Spain, unless you and Derivable.org agree on a different location. Unless otherwise agreed, the arbitrator may not consolidate your claims with those of any other party. Any judgment on the award rendered by the arbitrator may be entered in any court of competent jurisdiction.

It is important to note that any claim arising out of or related to these Terms, the Site, or the Interface must be filed within one year after the claim arises. Failure to do so may result in the claim being permanently barred, meaning you and Derivable.org will not have the right to assert the claim.
...
1. Any right or remedy of Derivable.org stated in these Terms is in addition to, and not in place of, any other right or remedy available under Applicable Law, at law, or in equity. The failure or delay of Derivable.org in exercising any right, power, or privilege under these Terms shall not be considered a waiver of that right.
...
5. You are not permitted to assign or transfer any right to use the Site, the Interface, or any of your rights or obligations under these Terms without the express prior written consent of Derivable.org. However, Derivable.org may assign or transfer their rights or obligations under these Terms without notice or obtaining your consent or approval.

6. These Terms constitute the entire agreement between you and Derivable.org and override any prior or contemporaneous understandings or agreements between the parties regarding the Interface, Site, or Interface.

7. If there is a conflict between these Terms and any other agreement you have with Derivable.org, these Terms will prevail unless the other agreement specifically states that it supersedes these Terms.
...
The section you provided states that Derivable.org, its affiliates, suppliers, contractors, and their respective stockholders, members, directors, officers, managers, employees, attorneys, agents, representatives, suppliers, and contractors shall not be liable for any direct, indirect, incidental, special, punitive, consequential, or similar damages or liabilities arising out of or in connection with the Site or the Interface, or any item provided by Derivable.org. This includes damages for loss of fiat, assets, data, information, revenue, opportunities, use, goodwill, profits, or other business or financial benefits. This limitation of liability applies regardless of the legal theory of liability (contract, tort, civil liability, etc.) and regardless of whether Derivable.org was aware of the possibility of such damages. Derivable.org also states that it is not responsible for the execution or settlement of transactions between users of the Interface.

CONTACT INFORMATION

If you have any questions about these Terms, the Site, or the Interface, please get in touch with Derivable.org on any of our official channels.`
